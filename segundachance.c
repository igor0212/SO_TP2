...
{    
    ...
    for(idx = 0; idx < tamanho_tabela; idx++)
    {
        ...
        //tabela.paginas[idx].chance = false;
    }
    ...
    {      
      ...
      {     
        *paginas_escritas+=1;
        ...
        //tabela.paginas[idx].chance = true;
        pagina_tabela = 1;
      ...
      *paginas_lidas+=1;
      ...
      if(idx_inserir < 0)
      {
        for(idx = 0; idx < tamanho_tabela; idx++)
        {
          ...
          if((idx == tamanho_tabela - 1))// && tabela.paginas[idx_inserir].chance)
          {   
              //tabela.paginas[idx_inserir].chance = false;           
              idx_inserir = 0;               
          }
        }
      }
